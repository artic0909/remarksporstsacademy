                        ...
                        <div class="get_t_content_inner">
                            ...
                            <div class="linkss">
                                <div class="inner_linkss" style="list-style-type: none;">
                                    <li class="round_back">
                                        <a href="mailto:example@example.com"><img src="{{ asset('/images/customer-service.png') }}" alt="Customer Service" /></a>
                                    </li>

                                    <li class="round_back">
                                        <a href="mailto:example@example.com"><img src="{{ asset('/images/envelop.png') }}" alt="Email" /></a>
                                    </li>
